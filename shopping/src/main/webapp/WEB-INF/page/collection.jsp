	...
	*/
	...
	function queryPage(page,size){
		...
		window.location.href=
			"findCollectByPage.do?"+
			"page="+page+"&"+
			"size="+size+"&"+
			"uid="+${sessionScope.logineduser.uid};
	}
</script>
									...
									<div class="s-item">
										...
										<div class="s-pic">
											<a href="#" class="s-pic-link">
												<img src="images/0-item_pic.jpg_220x220.jpg" alt="" title="${t.goods.gname }" class="s-pic-img s-guess-item-img">
											</a>
										</div>
										<div class="s-info">
											<div class="s-title"><a style="text-align: center;" href="#" title="${t.goods.gname }">${t.goods.gname }</a></div>
											<div class="s-price-box">
												<span class="s-price"><em class="s-price-sign">¥</em><em class="s-value">${t.goods.gprice }</em></span>
											</div>
											<div class="s-extra-box">
												<span class="s-sales">销量: ${t.goods.gsail }</span>
											</div>
										</div>
										<div class="s-tp">
											<span class="ui-btn-loading-before"><a style="color: white;" href="javascript:void(0);" onclick="delCollect(${t.collectid})" >取消收藏</a></span>
