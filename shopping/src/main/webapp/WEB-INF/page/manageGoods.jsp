...
<html>
	...
	<head>
		...
		<link rel="stylesheet" />
		<link rel="stylesheet" href="${path}/common/css/Site.css" />
		<link rel="stylesheet" href="${path}/common/css/zy.all.css" />
		<link rel="stylesheet" href="${path}/common/css/font-awesome.min.css" />
		<link rel="stylesheet" href="${path}/common/css/amazeui.min.css" />
	 	<link rel="stylesheet" href="${path}/common/css/admin.css" />
									...
									<table class="table" id="tbRecord">
										...
										<c:forEach items="${datas.content}" var="t">
											<tr>
												...
												<td class="delete"><button id="del" onclick="btn_delete(${t.gid })"><i class="icon-trash bigger-120"></i>删除</button></td>
											</tr>
										</c:forEach>	
										</tbody>
									</table>
...
<!-- 									<select name="typeId" required>
							...
							<div class="am-form-group">
								<label for="user-intro" class="am-u-sm-3 am-form-label">
									图片</label>
								<div class="am-u-sm-9">
									<input type="text" id="imgid" required
		...
		<!-- content end -->
			 ...
			 <script src="${path}/common/js/jquery-1.7.2.min.js" type="text/javascript"></script>
              <script src="${path}/common/js/plugs/Jqueryplugs.js" type="text/javascript"></script>
              <script src="${path}/common/js/_layout.js"></script>
             <script src="${path}/common/js/plugs/jquery.SuperSlide.source.js"></script>
			<script>
				var num = 1;
				$(function() {
