...
var s=$(_272).find("div.panel:visible,div.accordion:visible,div.tabs1-container:visible,div.layout:visible,.easyui-fluid:visible").filter(function(_274,el){
...
function _330(_331){
var opts=$.data(_331,"tabs1").options;
if(!opts.showHeader){
return;
}
var _332=$(_331).children("div.tabs1-header");
var tool=_332.children("div.tabs1-tool:not(.tabs1-tool-hidden)");
var _333=_332.children("div.tabs1-scroller-left");
var _334=_332.children("div.tabs1-scroller-right");
var wrap=_332.children("div.tabs1-wrap");
...
var _338=_32f(_332.find("ul.tabs1"));
...
function _33a(_33b){
var opts=$.data(_33b,"tabs1").options;
var _33c=$(_33b).children("div.tabs1-header");
if(opts.tools){
if(typeof opts.tools=="string"){
$(opts.tools).addClass("tabs1-tool").appendTo(_33c);
$(opts.tools).show();
}else{
_33c.children("div.tabs1-tool").remove();
var _33d=$("<div class=\"tabs1-tool\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>").appendTo(_33c);
var tr=_33d.find("tr");
...
cc._size(opts);
var _342=cc.children("div.tabs1-header");
var _343=cc.children("div.tabs1-panels");
var wrap=_342.find("div.tabs1-wrap");
var ul=wrap.find(".tabs1");
ul.children("li").removeClass("tabs1-first tabs1-last");
ul.children("li:first").addClass("tabs1-first");
ul.children("li:last").addClass("tabs1-last");
if(opts.tabPosition=="left"||opts.tabPosition=="right"){
...
_342.children("div.tabs1-scroller-left,div.tabs1-scroller-right,div.tabs1-tool:not(.tabs1-tool-hidden)").css("display",opts.showHeader?"block":"none");
...
if(_341.tabs1.length){
var d1=ul.outerWidth(true)-ul.width();
var li=ul.children("li:first");
var d2=li.outerWidth(true)-li.width();
var _344=_342.width()-_342.children(".tabs1-tool:not(.tabs1-tool-hidden)")._outerWidth();
var _345=Math.floor((_344-d1-d2*_341.tabs1.length)/_341.tabs1.length);
$.map(_341.tabs1,function(p){
_346(p,(opts.justified&&$.inArray(opts.tabPosition,["top","bottom"])>=0)?_345:undefined);
});
if(opts.justified&&$.inArray(opts.tabPosition,["top","bottom"])>=0){
var _347=_344-d1-_32f(ul);
_346(_341.tabs1[_341.tabs1.length-1],_345+_347);
}
}
_330(_33f);
function _346(p,_348){
var _349=p.panel("options");
var p_t=_349.tab.find("a.tabs1-inner");
...
function _34a(_34b){
var opts=$.data(_34b,"tabs1").options;
var tab=_34c(_34b);
if(tab){
var _34d=$(_34b).children("div.tabs1-panels");
...
function _350(_351){
var tabs1=$.data(_351,"tabs1").tabs1;
var cc=$(_351).addClass("tabs1-container");
var _352=$("<div class=\"tabs1-panels\"></div>").insertBefore(cc);
cc.children("div").each(function(){
_352[0].appendChild(this);
});
cc[0].appendChild(_352[0]);
$("<div class=\"tabs1-header\">"+"<div class=\"tabs1-scroller-left\"></div>"+"<div class=\"tabs1-scroller-right\"></div>"+"<div class=\"tabs1-wrap\">"+"<ul class=\"tabs1\"></ul>"+"</div>"+"</div>").prependTo(_351);
cc.children("div.tabs1-panels").children("div").each(function(i){
var opts=$.extend({},$.parser.parseOptions(this),{disabled:($(this).attr("disabled")?true:undefined),selected:($(this).attr("selected")?true:undefined)});
_35f(_351,opts,$(this));
});
cc.children("div.tabs1-header").find(".tabs1-scroller-left, .tabs1-scroller-right").hover(function(){
$(this).addClass("tabs1-scroller-over");
},function(){
$(this).removeClass("tabs1-scroller-over");
});
...
function _354(_355){
var _356=$.data(_355,"tabs1");
var opts=_356.options;
$(_355).children("div.tabs1-header").unbind().bind("click",function(e){
if($(e.target).hasClass("tabs1-scroller-left")){
$(_355).tabs1("scrollBy",-opts.scrollIncrement);
}else{
if($(e.target).hasClass("tabs1-scroller-right")){
$(_355).tabs1("scrollBy",opts.scrollIncrement);
}else{
var li=$(e.target).closest("li");
if(li.hasClass("tabs1-disabled")){
return false;
}
var a=$(e.target).closest("a.tabs1-close");
if(a.length){
_379(_355,_357(li));
}else{
if(li.length){
var _358=_357(li);
var _359=_356.tabs1[_358].panel("options");
if(_359.collapsible){
...
if(li.length){
opts.onContextMenu.call(_355,e,li.find("span.tabs1-title").html(),_357(li));
}
});
function _357(li){
var _35a=0;
...
function _35b(_35c){
var opts=$.data(_35c,"tabs1").options;
var _35d=$(_35c).children("div.tabs1-header");
var _35e=$(_35c).children("div.tabs1-panels");
_35d.removeClass("tabs1-header-top tabs1-header-bottom tabs1-header-left tabs1-header-right");
_35e.removeClass("tabs1-panels-top tabs1-panels-bottom tabs1-panels-left tabs1-panels-right");
if(opts.tabPosition=="top"){
_35d.insertBefore(_35e);
}else{
if(opts.tabPosition=="bottom"){
_35d.insertAfter(_35e);
_35d.addClass("tabs1-header-bottom");
_35e.addClass("tabs1-panels-top");
}else{
if(opts.tabPosition=="left"){
_35d.addClass("tabs1-header-left");
_35e.addClass("tabs1-panels-right");
}else{
if(opts.tabPosition=="right"){
_35d.addClass("tabs1-header-right");
_35e.addClass("tabs1-panels-left");
}
}
}
}
if(opts.plain==true){
_35d.addClass("tabs1-header-plain");
}else{
_35d.removeClass("tabs1-header-plain");
}
_35d.removeClass("tabs1-header-narrow").addClass(opts.narrow?"tabs1-header-narrow":"");
var tabs1=_35d.find(".tabs1");
tabs1.removeClass("tabs1-pill").addClass(opts.pill?"tabs1-pill":"");
tabs1.removeClass("tabs1-narrow").addClass(opts.narrow?"tabs1-narrow":"");
tabs1.removeClass("tabs1-justified").addClass(opts.justified?"tabs1-justified":"");
if(opts.border==true){
_35d.removeClass("tabs1-header-noborder");
_35e.removeClass("tabs1-panels-noborder");
}else{
_35d.addClass("tabs1-header-noborder");
_35e.addClass("tabs1-panels-noborder");
}
opts.doSize=true;
};
function _35f(_360,_361,pp){
_361=_361||{};
var _362=$.data(_360,"tabs1");
var tabs1=_362.tabs1;
if(_361.index==undefined||_361.index>tabs1.length){
_361.index=tabs1.length;
}
if(_361.index<0){
_361.index=0;
}
var ul=$(_360).children("div.tabs1-header").find("ul.tabs1");
var _363=$(_360).children("div.tabs1-panels");
var tab=$("<li>"+"<a href=\"javascript:;\" class=\"tabs1-inner\">"+"<span class=\"tabs1-title\"></span>"+"<span class=\"tabs1-icon\"></span>"+"</a>"+"</li>");
if(!pp){
pp=$("<div></div>");
}
if(_361.index>=tabs1.length){
tab.appendTo(ul);
pp.appendTo(_363);
tabs1.push(pp);
}else{
...
var p=$(_360).tabs1("getSelected");
if(p){
if(p[0]!=this){
$(_360).tabs1("unselect",_36b(_360,p));
p=$(_360).tabs1("getSelected");
if(p){
return false;
}
}else{
...
_364.tab.addClass("tabs1-selected");
var wrap=$(_360).find(">div.tabs1-header>div.tabs1-wrap");
...
$(_360).tabs1("scrollBy",_366);
}else{
$(_360).tabs1("scrollBy",0);
}
...
$(this).panel("options").tab.removeClass("tabs1-selected");
},onClose:function(){
if(_361.onClose){
...
$(_360).tabs1("update",{tab:pp,options:pp.panel("options"),type:"header"});
};
function _36c(_36d,_36e){
var _36f=$.data(_36d,"tabs1");
...
var _374=$.data(_372,"tabs1").selectHis;
var pp=_373.tab;
...
var tab=opts.tab;
if(opts.header){
tab.find(".tabs1-inner").html($(opts.header));
}else{
var _376=tab.find("span.tabs1-title");
var _377=tab.find("span.tabs1-icon");
_376.html(opts.title);
_377.attr("class","tabs1-icon");
tab.find("a.tabs1-close").remove();
if(opts.closable){
_376.addClass("tabs1-closable");
$("<a href=\"javascript:;\" class=\"tabs1-close\"></a>").appendTo(tab);
}else{
_376.removeClass("tabs1-closable");
}
if(opts.iconCls){
_376.addClass("tabs1-with-icon");
_377.addClass(opts.iconCls);
}else{
_376.removeClass("tabs1-with-icon");
}
if(opts.tools){
var _378=tab.find("span.tabs1-p-tool");
if(!_378.length){
var _378=$("<span class=\"tabs1-p-tool\"></span>").insertAfter(tab.find("a.tabs1-inner"));
}
if($.isArray(opts.tools)){
_378.empty();
for(var i=0;i<opts.tools.length;i++){
...
if($(this).parents("li").hasClass("tabs1-disabled")){
return;
}
...
tab.find("span.tabs1-p-tool").remove();
_376.css("padding-right","");
}
}
}
if(opts.disabled){
opts.tab.addClass("tabs1-disabled");
}else{
opts.tab.removeClass("tabs1-disabled");
}
_33e(_372);
$.data(_372,"tabs1").options.onUpdate.call(_372,opts.title,_36b(_372,pp));
};
function _379(_37a,_37b){
var _37c=$.data(_37a,"tabs1");
var opts=_37c.options;
var tabs1=_37c.tabs1;
...
_37c.selectHis=his;
var _383=$(_37a).tabs1("getSelected");
if(!_383&&his.length){
_381=_37c.selectHis.pop();
$(_37a).tabs1("select",_381);
}
};
function _37f(_384,_385,_386){
var tabs1=$.data(_384,"tabs1").tabs1;
var tab=null;
if(typeof _385=="number"){
if(_385>=0&&_385<tabs1.length){
tab=tabs1[_385];
if(_386){
tabs1.splice(_385,1);
}
...
var tabs1=$.data(_388,"tabs1").tabs1;
for(var i=0;i<tabs1.length;i++){
if(tabs1[i][0]==$(tab)[0]){
return i;
}
...
function _34c(_389){
var tabs1=$.data(_389,"tabs1").tabs1;
for(var i=0;i<tabs1.length;i++){
var tab=tabs1[i];
if(tab.panel("options").tab.hasClass("tabs1-selected")){
return tab;
}
}
return null;
...
function _38a(_38b){
var _38c=$.data(_38b,"tabs1");
var tabs1=_38c.tabs1;
for(var i=0;i<tabs1.length;i++){
var opts=tabs1[i].panel("options");
...
function _38f(_393){
$(_393).children("div.tabs1-panels").each(function(){
$(this).stop(true,true);
});
};
...
var opts=$.data(_397,"tabs1").options;
opts.showHeader=_398;
$(_397).tabs1("resize");
};
function _399(_39a,_39b){
var tool=$(_39a).find(">.tabs1-header>.tabs1-tool");
if(_39b){
tool.removeClass("tabs1-tool-hidden").show();
}else{
tool.addClass("tabs1-tool-hidden").hide();
}
$(_39a).tabs1("resize").tabs1("scrollBy",0);
};
$.fn.tabs1=function(_39c,_39d){
if(typeof _39c=="string"){
return $.fn.tabs1.methods[_39c](this,_39d);
}
_39c=_39c||{};
return this.each(function(){
var _39e=$.data(this,"tabs1");
if(_39e){
$.extend(_39e.options,_39c);
}else{
$.data(this,"tabs1",{options:$.extend({},$.fn.tabs1.defaults,$.fn.tabs1.parseOptions(this),_39c),tabs1:[],selectHis:[]});
_350(this);
}
_33a(this);
_35b(this);
...
$.fn.tabs1.methods={options:function(jq){
var cc=jq[0];
var opts=$.data(cc,"tabs1").options;
var s=_34c(cc);
opts.selected=s?_36b(cc,s):-1;
return opts;
},tabs1:function(jq){
return $.data(jq[0],"tabs1").tabs1;
...
return jq.each(function(){
var opts=$(this).tabs1("getTab",_3a7).panel("options");
opts.tab.removeClass("tabs1-disabled");
opts.disabled=false;
});
},disableTab:function(jq,_3a8){
return jq.each(function(){
var opts=$(this).tabs1("getTab",_3a8).panel("options");
opts.tab.addClass("tabs1-disabled");
opts.disabled=true;
});
...
return jq.each(function(){
var opts=$(this).tabs1("options");
var wrap=$(this).find(">div.tabs1-header>div.tabs1-wrap");
...
$.fn.tabs1.parseOptions=function(_3ab){
...
$.fn.tabs1.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:32,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_3ac){
