			...
			<div class="res-main">
				...
				<div class="login-box">
						...
						<div class="am-tabs" id="doc-my-tabs">
							...
							<div class="am-tabs-bd">
								<div class="am-tab-panel am-active">
									<form action="../registerByEmail.do" method="post">
                 ...
                 <div class="user-pass">
								    ...
								    <input type="password" name="reupass" id="passwordRepeat" placeholder="确认密码">
                 </div>	
								...
								<div class="am-tab-panel">
									<form action="../registerByPhone.do" method="post">
                 <div class="user-phone">
								    ...
								    <input type="tel" name="phone" id="phone" placeholder="请输入手机号" >
										...
										<div class="verification">
											<label for="code"><i class="am-icon-code-fork"></i></label>
											<input type="tel" name="pcode" id="pcode" placeholder="请输入验证码">
											<a class="btn" href="javascript:void(0);" onclick="sendMobileCode();" id="sendMobileCode">
												<span id="dyMobileButton">获取</span></a>
										</div>
				<div class="user-email">
					<!-- <div class="am-ion-user am-icon-fw"> -->
