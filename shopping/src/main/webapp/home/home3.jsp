	...
	<body>
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${path}/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
                 ...
                 <div class="clear "></div>
					...
					<div class="am-g am-g-fixed flood method3 ">
						<ul class="am-thumbnails ">
							...
							<li>
								<div class="list ">
									<a href="introduction.jsp?gid=2">
										<img src="${path}/images/cp.jpg " />
										<div class="pro-title ">棒棒糖</div>
										<span class="e-price ">100</span>
									</a>
								</div>
							</li>
		...
		<script type="text/javascript " src="${path}/basic/js/quick_links.js "></script>
 		...
 		<script type="text/javascript">
			...
			function findColByPage(uid){
				$.ajax({
					url:"${path}/findCollectByPage.do",
					type:"POST",
					data:{uid:uid},
					success:function(data){
						window.location.href="${path}/findCollectByPage.do?uid="+uid;
