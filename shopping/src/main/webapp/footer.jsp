				...
				<div id="sidebar">
					<div id="wrap">
						<div id="prof" class="item">
							...
							<div class="ibar_login_box status_login">
								...
								<div class="login_btnbox">
									...
									<a href="javascript:void(0);" onclick="findColByPage(uid=${sessionScope.logineduser.uid})" class="login_favorite">我的收藏</a>
								</div>
						...
						<div id="brand" class="item">
							<a href="javascript:void(0);" onclick="findColByPage(uid=${sessionScope.logineduser.uid})">
